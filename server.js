...
app.post('/userlogin', async (req, res) => {
    ...
    try {
        const response = await fetch('http://192.168.1.146:8060/trial_1/login', {
            method: 'POST',
...
app.post('/appointments', async (req, res) => {
    ...
    try {
        const response = await fetch('http://192.168.1.146:8060/trial_1/appoinements', {
            method: 'POST',
...
app.post('/patienthistory', async (req, res) => {
    ...
    try {
        const response = await fetch('http://192.168.1.146:8060/trial_1/patienthistory', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
